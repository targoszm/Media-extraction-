...
# get the list of files in the split directory
files = os.listdir('lex_fridman_podcast_dylan_patel_split')

# sort the files by name
files.sort()

for file in files:
    podcast_file = client.files.upload(file=f'lex_fridman_podcast_dylan_patel_split/{file}')
